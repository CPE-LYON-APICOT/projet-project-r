...
public class InventoryController {
    ...
    // Code to save the deck
}

    
    @FXML
    protected void loadDeck() {
    // Code to load the deck
}
...
protected void sortCardsByFactionChaos() {
    ...
    for (carte carte : cartes) {
     ...
     public void setInventory() {
        ...
        fact.add(Chaos);
        // Carte 1
        cartes.add(new carteMonstre("Gardien du Temple", 11, "Un gardien mystique protégeant un ancien temple sacré.", 6, 11, "imageProjet/gardien_temple.jpeg", Ordre));
        ...
        // Carte 4
        cartes.add(new carteMonstre("Chevalier de l'Aube", 14, "Un noble chevalier vêtu d'une armure étincelante, se battant pour la justice et l'honneur.", 9, 14, "imageProjet/chevalier_aube.jpeg", Ordre));
        ...
        // Carte 6
        cartes.add(new carteMonstre("Gardien des Montagnes", 16, "Un colosse de pierre, protecteur des montagnes et des vallées.", 11, 16, "imageProjet/gardien_montagnes.jpeg", Ordre));
        ...
        // Carte 9
        cartes.add(new carteMonstre("Ange de l'Aurore", 19, "Un ange céleste descendu des cieux pour apporter la lumière et la bénédiction sur le monde des mortels.", 14, 19, "imageProjet/ange_aurore.jpeg", Ordre));
        ...
        // Carte 12
        cartes.add(new carteMonstre("Gardien de la Forêt Éternelle", 22, "Un esprit ancestral veillant sur la forêt éternelle, où le temps ne s'écoule jamais.", 17, 22, "imageProjet/gardien_foret.jpeg", Ordre));
        ...
        // Carte 15
        cartes.add(new carteMonstre("Paladin de l'Aube", 25, "Un chevalier saint, portant une armure dorée et brandissant une épée de lumière contre les forces des ténèbres.", 20, 25, "imageProjet/paladin_aube.jpeg", Ordre));
        ...
        // Carte 18
        cartes.add(new carteMonstre("Dragon de l'Aube", 28, "Un dragon majestueux, émergeant des premières lueurs du jour pour défendre les innocents contre les ténèbres.", 23, 28, "imageProjet/dragon_aube.jpeg", Ordre));
        ...
        // Carte 21
        cartes.add(new carteMonstre("Esprit de la Lune", 31, "Un esprit bienveillant émergeant des douces lueurs de la lune, apportant la sérénité et la guérison à ceux qui croisent son chemin.", 26, 31, "imageProjet/esprit_lune.jpeg", Ordre));
        ...
        // Carte 24
        cartes.add(new carteMonstre("Protecteur Sacré", 34, "Un protecteur céleste, gardien des lieux saints et des âmes pures, défendant les innocents contre les forces du mal.", 29, 34, "imageProjet/protecteur_sacre.jpeg", Ordre));
        ...
        // Carte 27
        cartes.add(new carteMonstre("Sylphe des Bois", 37, "Un esprit des bois, protecteur des écosystèmes forestiers, veillant sur la flore et la faune avec bienveillance.", 32, 37, "imageProjet/sylphe_bois.jpeg", Ordre));
        ...
        // Carte 30
        cartes.add(new carteMonstre("Gardien des Étoiles", 40, "Un être céleste, veillant sur les étoiles et les constellations, protégeant les secrets et les mystères des cieux.", 35, 40, "imageProjet/gardien_etoles.jpeg", Ordre));
        // Carte 31
        cartes.add(new carteMonstre("Élémentaire de Feu", 41, "Un esprit de feu impétueux, consumant tout sur son passage avec sa rage ardente et sa puissance incandescente.", 36, 41, "imageProjet/elementaire_feu.jpeg", Ordre));
        ...
        // Carte 34
        cartes.add(new carteMonstre("Sage de l'Ancien Savoir", 44, "Un érudit mystique, gardien des connaissances anciennes et des secrets perdus dans les âges.", 39, 44, "imageProjet/sage_savoir.jpeg", Ordre));
        ...
        // Carte 42
        cartes.add(new carteMonstre("Sorcier Maudit", 52, "Un puissant sorcier maudit par des forces obscures, utilisant ses pouvoirs pour assouvir sa soif de vengeance et de pouvoir.", 47, 52, "imageProjet/sorcier_maudit.jpeg", Ordre));
        ...
        cartes.add(new carteMonstre("Hydre de l'Enfer", 54, "Un monstre infernal à multiples têtes, surgissant des flammes de l'enfer pour semer la destruction et la terreur sur son passage.", 49, 54, "imageProjet/hydre_enfer.jpeg", Chaos));
         ...
         // Carte 45
        cartes.add(new carteMonstre("Mage de l'Arcane", 55, "Un maître des arcanes, manipulant les énergies mystiques pour façonner la réalité selon sa volonté et ses désirs.", 50, 55, "imageProjet/mage_arcane.jpeg", Ordre));
        ...
        // Carte 48
        cartes.add(new carteMonstre("Sage de la Sagesse Ancienne", 58, "Un sage vénérable, gardien des connaissances anciennes et des secrets enfouis dans les annales du temps.", 53, 58, "imageProjet/sage_sagesse.jpeg", Ordre));
